                    ...
                    children: <Widget>[
                      Container(
                        ...
                        decoration: BoxDecoration(
                         ...
                         child: Image.memory(Utility.dataFromBase64String(list[position].image)),
                      ),
                      Text(snapshot.data[position].name, style: TextStyle(color: Colors.grey),),
                      SizedBox(height: 5,),
                      Text("${snapshot.data[position].price} \$")
                    ],
                  ),
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => DetialItem(list[position]),));
                  },
              )
          ),
        ),
